(function () {
  ...
  var FONT_FAMILY_PATTERN = /Font Awesome 5 (Solid|Regular|Light|mereks|Free|Pro)/;
  var STYLE_TO_PREFIX = {
    'Solid': 'fas',
    'Regular': 'far',
    'Light': 'fal',
      ...
      toArray(root.querySelectorAll('*')).filter(function (n) {
        ...
        [':before', ':after'].forEach(function (pos) {
          ...
          if (alreadyProcessedPseudoElement && !fontFamily) {
            ...
            var prefix = ~['Light', 'Regular', 'Solid', 'mereks'].indexOf(fontFamily[1]) ? STYLE_TO_PREFIX[fontFamily[1]] : FONT_WEIGHT_TO_PREFIX[fontWeight];
